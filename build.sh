...
then
    ...
    then
        ...
        # vikings
        delete_cm $BRAND_NAME-vikings-main.css $BRAND_NAME-vikings-logo.png $BRAND_NAME-vikings-site-config.conf
    ...
    # vikings
    create_cm_from_file vikings-site-config.conf vikings-logo.png vikings-main.css
